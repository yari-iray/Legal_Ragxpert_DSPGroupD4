...
class DefaultElement:
    ...
    HELLO_MESSAGE: str = "Hello, how can I help you with your legal questions?"
    SET_MODEL_MESSAGE: str = "Please select a model first"
    EMPTY_MESSAGE: str = "Enter your message please"
    ...
    PROCESS_DOCUMENT_SUCCESS_STATUS: str = "Documents imported successfully!"
    PROCESS_DOCUMENT_EMPTY_STATUS: str = "Empty documents found, please only provide documents with content"
    ANSWERING_STATUS: str = "Querying legal knowledge base"
    COMPLETED_STATUS: str = "Answer given"
...
class LocalChatbotUI:
    def __init__(
        ...
        avatar_images: list[str] = ["./assets/user.png", "./assets/bot.jpg"],
    ):
